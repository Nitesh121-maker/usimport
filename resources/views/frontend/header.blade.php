  <nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200 main-nav">
    ...
    <div class="px-2 md:px-5 lg:px-5 lg:py-1 md:py-3 py-1 lg:px-0 max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <a href="/contact">
            <button class="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-glory-red to-glory-blue group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white focus:outline-none">
      ...
      <div class="items-center justify-between mb-3 lg:mb-0 md:mb-0 hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900">
          ...
          <li>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownDelay" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
          ...
          <li>
            <a href="/search-live-data" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              Search Live Data
            </a>
          </li>
          <li>
            <a href="/faq" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              Faqs
            </a>
          </li>
        </ul>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
              <form class="space-y-4" action="">
                ...
                <button type="submit" class="w-full text-white bg-gradient-to-br from-glory-red to-glory-blue hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-glory-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Submit
                </button>
