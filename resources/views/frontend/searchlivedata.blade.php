...
<body>
    ...
    <section class="animate-text bg-gradient-to-r from-glory-red via-fuchsia-600 to-glory-blue">
        <div class="mx-auto mx-w-screen-xl px-5 md:px-12 lg:px-5 py-32">
            {{-- Data not found popup --}}
            <div class="flex justify-center items-center">
                <div id="toast-danger" class="flex items-center max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow" style="width: 25%" role="alert">
                    <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg" style="color: red;"> 
                    ...
                    <div class="ms-3 text-md font-medium" style="margin: 5%">
