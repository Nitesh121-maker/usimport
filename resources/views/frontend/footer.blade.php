    <footer class="bg-gray-50">
        <div class="px-5 md:px-8 lg:px-5 mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-16">
            <div class="grid gap-4 grid-cols-1 lg:grid-cols-3 md:grid-cols-1 sm:gap-6 sm:grid-cols-3">
                <div class="grid gap-4 grid-cols-1 md:grid-cols-1 lg:grid-cols-2 col-span-2">
                    {{-- About Us --}}
                    <div> 
                        ...
                        <p class="mt-0 text-gray-500 font-medium !leading-7 text-start">
                            Usimportdata is the best platform when it comes to providing United States import-export data. 
                            We follow our cutting-edge techniques to design US Trade Data along with customizable trade reports 
                            and provide you with the best and error-free database. Contact us now for a quote and avail 
                            exclusive benefits.
                        </p>
                    </div>
                    {{-- Company & Our data --}}
                    ...
                    <div class="grid col-span-0 lg:col-span-2 grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- US Top Imports data --}}
                        <div>
                            <h2 class="mb-6 text-lg lg:text-md font-semibold text-gray-900 uppercase">
                                US Top Imports data
                            ...
                            <ul class="text-gray-500 font-medium">
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/import/oil" target="_blank" class="hover:underline">
                                        Oil Import Data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/import/car" target="_blank" class="hover:underline">
                                        Car Import Data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/import/food" target="_blank" class="hover:underline">
                                        Food Import Data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/import/surgical-equipement" target="_blank" class="hover:underline">
                                        surgical equipment Import Data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/import/human-blood" target="_blank" class="hover:underline">
                                        Human blood Import Data
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="text-gray-500 font-medium">
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/export/pharmaceutical" target="_blank" class="hover:underline">
                                        Pharmaceutical Export data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/export/Electronics" target="_blank" class="hover:underline">
                                        Electronics export data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/export/oil" target="_blank" class="hover:underline">
                                        Oil Export Data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/export/vehicles" target="_blank" class="hover:underline">
                                        Vehicles Export Data
                                    </a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://usimportdata.com/search-data/data/export/soybean" target="_blank" class="hover:underline">
                                        Soybean Export Data
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
                    {{-- Form --}}
