        ...
        <nav class="flex px-16 pt-24 lg:pt-24 md:pt-28 pb-4 text-gray-700 bg-white" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a href="/" class="inline-flex items-center text-xs lg:text-sm font-medium text-gray-700 hover:text-blue-600">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-xs lg:text-sm font-medium text-gray-900 hover:text-blue-600 md:ms-2">
                            Data Directory
                        </a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="line-clamp-1 ms-1 text-xs lg:text-sm font-medium text-gray-500 md:ms-2">
                            Import Live Data
                        </span>
                    </div>
                </li>
